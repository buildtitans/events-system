...
const inputValidation_2 = require("../inputValidators/inputValidation");
exports.eventsRouter = (0, init_1.router)({
    ...
    newEvent: init_1.protectedProcedure
        .input(inputValidation_1.NewEventInputValidator)
    ...
    eventsById: init_1.publicProcedure
        .input(inputValidation_2.EventIdInputValidator)
        .mutation(async ({ ctx, input }) => {
    ...
    getEvent: init_1.publicProcedure
        .input(inputValidation_2.EventIDValidator)
        .mutation(async ({ ctx, input }) => {
    ...
    search: init_1.publicProcedure
        .input(inputValidation_2.searchInputValidator)
        .mutation(async ({ ctx, input }) => {
