...
class GroupMembersClient {
    ...
    async getMemberCountsByGroupIds(groupIds) {
        ...
        return (0, schemaValidators_1.MemberCountSchemaValidator)(counts);
    }
    ...
    parseRawMember(raw) {
        ...
        return (0, schemaValidators_1.ValidateGroupMember)({
    ...
    parseRawMembers(raw) {
        ...
        return (0, schemaValidators_1.ValidateGroupMembersArray)(parsed);
    }
}
