...
const slugify_1 = require("@/src/server/core/lib/utils/slugify");
class GroupsClient {
    db;
    constructor(db) {
        this.db = db;
    ...
    formatRawGroups(groups) {
        ...
        const validGroups = (0, schemaValidators_1.GroupsSchemaValidator)(formatted);
        return validGroups;
    }
    ...
    toGroupSchema(group) {
        ...
        return (0, schemaValidators_1.GroupSchemaValidator)(formatted);
    }
    formatGroup(group) {
        return {
            id: group.id,
