...
class ParticipationsService {
    ...
    async getUserRsvpToEvent(user_id, event_id) {
        ...
        return (0, schemaValidators_1.RsvpStatusSchemaValidator)(result);
    }
    ...
    async getMemberships(user_id) {
        ...
        return (0, schemaValidators_1.UserMembershipSchemaArrayValidator)(parsed);
    }
    async getRsvpdEvents(user_id) {
        ...
        return (0, schemaValidators_1.RsvpSchemaArrayValidator)(rsvps);
    }
}
