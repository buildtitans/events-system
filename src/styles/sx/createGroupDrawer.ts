const createGroupDrawerPaperSx = {
  width: { xs: 350, md: 550 },
...
const createGroupDrawerHeaderSx = {
  position: "relative",
  zIndex: 1,
  display: "flex",
  flexDirection: "column",
...
const createGroupDrawerEyebrowSx = {
  color: "#7cc6ff",
  fontSize: "0.72rem",
  fontWeight: 700,
...
const createGroupDrawerTitleSx = {
  color: "#ffffff",
  fontWeight: 600,
...
const createGroupDrawerDescriptionSx = {
  maxWidth: "34ch",
...
const createGroupFieldControlSx = {
  width: "100%",
  display: "flex",
};

const createGroupTextFieldSx = {
  width: "100%",
  "& .MuiInputBase-root": {
    borderRadius: 2.8,
    background:
...
const createGroupSelectLabelSx = {
  color: "rgba(255, 255, 255, 0.58)",
  "&.Mui-focused": {
    color: "#7cc6ff",
  },
...
const createGroupPrimaryButtonSx = {
  minHeight: 48,
  borderRadius: 999,
